    ...
    public function storeKitsItems(): void {  
		 ...
		 $kit = new Config($this->plugin->kitFolder . "/kit1.yml", Config::YAML);
            	 $userinterface = [
      	    		...
      	    		$kit->setNested("helmet", 310),
      	    		$kit->setNested("chesplate", 311),
      	    		$kit->setNested("leggings", 312),
      	    		$kit->setNested("boots", 313),
      	    		$kit->setNested("sword", 276),
      	    		$kit->setNested("pickaxe", 278),
     	    		$kit->setNested("axe", 293),
      	    		$kit->setNested("hoe", 293),
      	    		$kit->setNested("Armorenchant1", 1),
      	    		$kit->setNested("Armorlevel1", 1),
      	    		$kit->setNested("Armorenchant2", 2),
      	    		$kit->setNested("Armorlevel2", 1),
      	    		$kit->setNested("Toolenchant1", 15),
      	    		$kit->setNested("Toollevel1", 1),
      	    		$kit->setNested("Toolenchant2", 17),
      	    		$kit->setNested("Toollevel2", 1),
      	    		$kit->setNested("Swordenchant1", 17),
      	    		$kit->setNested("Swordlevel1", 1),
      	    		$kit->setNested("Swordenchant2", 9),
